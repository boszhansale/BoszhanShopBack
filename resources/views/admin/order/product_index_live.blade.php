    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                {{-- <div class="col-md-2">--}}
                    {{-- <small>поиск</small>--}}
                    {{-- <input wire:model="search" type="search" name="search" placeholder="поиск"
                        class="form-control">--}}
                    {{-- </div>--}}
                ...
                <div class="col-md-2">
                    <a href="{{route('admin.order.productExcel', ['start_created_at' => $start_created_at, 'end_created_at' => $end_created_at, 'store_id' => $storeId, 'search' => $search])}}"
                        target="_blank" class="btn btn-primary">скачать Excel</a>
                </div>
            </div>
        </div>
    </div>
